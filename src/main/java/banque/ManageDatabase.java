...
public class ManageDatabase {
    ...
    private static ConnectDatabase con= new ConnectDatabase();
    ...
    public void inserer(String numeroCompte,String titulaire,Double solde ,String TYPE, Double decouvertAutorise, Double taux) throws SQLException {
        String query = "INSERT INTO CompteBancaire (numeroCompte, titulaire, solde, TYPE, decouvertAutorise, taux) VALUES (?, ?, ?, ?, ?, ?)";
        try (PreparedStatement  preparedStatement = conn.prepareStatement(query)) {
            preparedStatement.setString(1, numeroCompte);
            preparedStatement.setString(2, titulaire);
            preparedStatement.setDouble(3, solde);
            preparedStatement.setString(4, TYPE);
            if (decouvertAutorise != null) {
                preparedStatement.setDouble(5, decouvertAutorise);
            } else {
                preparedStatement.setNull(5, java.sql.Types.DOUBLE);
            }
            if (taux != null) {
                preparedStatement.setDouble(6, taux);
            } else {
